...
namespace MorgBot.TwitchAPI.Clients
{
    public class TwitchReadOnlyClient : ITwitchClient
    {
        ...
        public TwitchList<FollowedChannel> GetFollowedChannels(
                                                               string user,
                                                               PagingInfo pagingInfo = null,
                                                               SortDirection sortDirection = SortDirection.Descending,
                                                               SortType sortType = SortType.Created_At)
        {
        ...
        public TwitchList<Game> SearchGames(string query, bool live = false, PagingInfo pagingInfo = null)
        {
            ...
            request.AddParameter("query", query);
            request.AddParameter("type", "suggest");                    // Currently the only type.
        ...
        // Stream is null if channel is offline
        ...
        public TwitchList<Stream> GetStreams(string game = null,
                                             string channel = null,
        ...
        public TwitchList<Video> GetTopVideo(string game = null,
