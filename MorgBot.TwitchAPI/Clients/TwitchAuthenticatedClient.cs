...
using MorgBot.TwitchAPI.Models;

namespace MorgBot.TwitchAPI.Clients
{
    class TwitchAuthenticatedClient : TwitchReadOnlyClient, ITwitchClient
    {
        ...
        public TwitchAuthenticatedClient(string clientId, string oauth) : base(clientId)
        {
            ...
            {
                throw new TwitchException("Couldn't get the username.");
            }

            this.username = user.Name;
        }

        new public RestRequest GetRequest(string url, Method method)
        {
            RestRequest restRequest = new RestRequest(url, method);
            restRequest.AddHeader("Authorization", String.Format("OAauth {0}", oauth));
            return restRequest;
        }
        ...
        public Channel Update(string status = null,
                              string game = null,
                              string delay = null)
        {
        ...
        // Length of commercial break is in seconds.
        // Default value is 30.
        // Valid values are 30, 60, 90, 120, 150, and 180.
        // You can only trigger a commercial once every 8 minutes.
        public TwitchResponse TriggerCommercials(int length)
        {
        ...
        // Only for Partners.
        public TwitchList<Subscription> GetSubscribers(PagingInfo pagingInfo = null,
        ...
        // A channel user is subscribed to.
        ...
        // Can we subscribe to the channel?
